          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                disabled={!canInvite}
                onClick={() => setShowInvite(true)}
                className={`px-3 py-1 rounded border ${canInvite
                    ? "bg-white/5 border-white/10 hover:bg-white/10"
            ...
            <div className="px-6 py-4 flex justify-between items-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  disabled={!canUpload}
                  onClick={() => fileInputRef.current?.click()}
                  className={`px-4 py-2 rounded ${canUpload ? "bg-blue-600" : "bg-gray-600 cursor-not-allowed"
                    }`}
                >
                  Upload
                </button>
                ...
                <tbody>
                  ...
                  {logs.map((log, i) => (
                    <tr key={i} className="border-b border-white/5 hover:bg-white/[0.02]">
                      ...
                      <td className="p-4">
                        <span className={`px-2 py-1 rounded text-xs ${log.role === 'owner' ? 'bg-purple-500/20 text-purple-300' :
                      ...
                      <td className="p-4">
                        <span className={`px-2 py-1 rounded text-xs font-mono ${log.action.includes('DENIED') ? 'bg-red-500/20 text-red-400' :
